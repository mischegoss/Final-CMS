...
export default class DataSheet_localizationSheet extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item = {};
    this.items.push(item);
    item['key'] = "restaurantdetails_text_638936";
    item['en'] = "New text. Double-click to ed";
    
    item = {};
    this.items.push(item);
    item['key'] = "restaurantdetails_checkbox_973158";
    item['en'] = "New option";
    
    item = {};
    this.items.push(item);
    item['key'] = "loginmain_text3_482998";
    item['en'] = "(Redner)";
    
    item = {};
    this.items.push(item);
    item['key'] = "loginmain_text3_985220";
    item['en'] = "(Redner)";
    
    item = {};
    this.items.push(item);
    item['key'] = "friends_button_509452";
    item['en'] = "New button";
    
    item = {};
    this.items.push(item);
    item['key'] = "friends_button_881866";
    item['en'] = "New button";
    
    item = {};
    this.items.push(item);
    item['key'] = "details_text_1003040";
    item['en'] = "Tamar";
    
    item = {};
    this.items.push(item);
    item['key'] = "details_text2_87323";
    item['en'] = "13322079252";
    
    item = {};
    this.items.push(item);
    item['key'] = "details_button_837183";
    item['en'] = "DELETE";
    
    item = {};
    this.items.push(item);
    item['key'] = "friends_item_text_167027";
    item['en'] = "(Phone Number)";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_text_409162";
    item['en'] = "ADD Number in Form +15551212";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_text_993609";
    item['en'] = "OR";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_field_514032";
    item['en'] = "Add name";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_field_257389";
    item['en'] = "+15551212";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_field_531510";
    item['en'] = "Image URL";
    
    item = {};
    this.items.push(item);
    item['key'] = "addauser_button_70349";
    item['en'] = "ADD NEW USER";
  }
