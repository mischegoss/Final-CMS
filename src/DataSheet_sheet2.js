...
export default class DataSheet_sheet2 extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    this.items.push(item);
    item['img_Name'] = "Billy";
    item['document_key'] = "7bq9Ze6sVoIs5xMQzki0";
    item['img_URL'] = "https://media3.giphy.com/media/9Y5BbDSkSTiY8/giphy.gif";
    item['img_Number'] = "304-242-2000";
    item.key = key++;
    
    item = {};
    this.items.push(item);
    item['img_Name'] = "Tamar Auber";
    item['document_key'] = "I48Z0dJRfw8MBqTKKWRC";
    item['img_URL'] = "https://lh6.googleusercontent.com/-vRPIvK5oQgo/AAAAAAAAAAI/AAAAAAAACYQ/hclVCYOIEuI/photo.jpg";
    item['img_Number'] = "";
    item.key = key++;
    ...
    this.items.push(item);
    item['img_Name'] = "Tamar Auber";
    item['document_key'] = "tm5JyalaHFINkEENGW3W";
    item['img_URL'] = "https://lh6.googleusercontent.com/-vRPIvK5oQgo/AAAAAAAAAAI/AAAAAAAACYQ/hclVCYOIEuI/photo.jpg";
    item['img_Number'] = "3042422232";
    item.key = key++;
  }
